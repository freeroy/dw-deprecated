 ...
 */
public abstract class BodyTagSupport extends javax.servlet.jsp.tagext.BodyTagSupport {

	private static Log log = LogFactory.getLog(BodyTagSupport.class);
	 ...
	 * @throws JspException
	 */
	public String getBodyString() throws JspException {
