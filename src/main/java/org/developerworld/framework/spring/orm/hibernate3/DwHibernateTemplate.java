...
public class DwHibernateTemplate extends HibernateTemplate {
	 ...
	 * @param query
	 */
	protected void fixQuery(Query query) {
		if (query != null)
			prepareQuery(query);
	}
	 ...
	 * @param criteria
	 */
	protected void fixCriteria(Criteria criteria) {
		if (criteria != null)
	 ...
	 * @param params
	 */
	protected void fixQuery(Query query, Map<String, Object> params) {
	 ...
	 * @param params
	 */
	protected void fixQuery(Query query, Object params[]) {
		if (query != null && params != null) {
			fixQuery(query);
	 ...
	 * @param params
	 */
	protected void fixQuery(Query query, String paramNames, Object values) {
	 ...
	 */
	protected <T> T findSingleByQuery(Query query) throws DataAccessException {
	 ...
	 * @throws DataAccessException
	 */
	protected <T> T findSingleByCriteria(final Criteria criteria)
			throws DataAccessException {
	 ...
	 * @throws DataAccessException
	 */
	public long findLong(final String hql, final Map<String, Object> params)
			throws DataAccessException {
